...
export default function LandingPage() {
  ...
  const servicesData = [
    ...
    { title: "Lifestyle Content", icon: <Zap size={24} />, desc: "High-end brand narratives that connect.", file: assets.bagelWorks },
    { title: "High-Energy Recaps", icon: <Smartphone size={24} />, desc: "Fast-paced hype edits built for engagement.", file: assets.armor }
  ];
    ...
    <div className="bg-[#050505] text-white min-h-screen font-sans selection:bg-white selection:text-black overflow-x-hidden scroll-smooth text-left cursor-default">
        ...
        <nav className="flex justify-between items-center w-full max-w-5xl px-8 py-4 rounded-full bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl">
          <div onClick={() => window.scrollTo({top: 0, behavior: 'smooth'})} className="flex items-center gap-3 cursor-pointer group leading-none">
            <div className="w-10 h-10 rounded-full overflow-hidden border border-white/10 flex items-center justify-center bg-zinc-900 shadow-inner group-hover:border-white/40 transition-colors">
              <img src={assets.logo} alt="Avora Logo" className="w-full h-full object-cover scale-110 rounded-full" />
            </div>
      ...
      <section id="about" className="px-6 py-40 max-w-7xl mx-auto border-t border-white/5 scroll-mt-32">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-24 items-center text-left">
          ...
          <div className="space-y-10">
            <h2 className="text-6xl md:text-8xl font-black tracking-tighter uppercase leading-[0.85]">Visual <br/>Strategy.</h2>
            <p className="text-gray-500 text-xl font-light leading-relaxed">Based in Maryland, I specialize in crafting modern, high-impact visuals that feel fresh, premium, and unmistakably on-brand.</p>
      ...
      <section id="services" className="px-6 py-40 bg-white text-black rounded-[5rem] mx-3 shadow-2xl scroll-mt-32">
        <div className="max-w-7xl mx-auto text-left">
          <h2 className="text-7xl font-black tracking-tighter uppercase leading-[0.8] mb-24 leading-none">Built to Scale.</h2>
      ...
      <section id="faq" className="px-6 py-40 max-w-5xl mx-auto scroll-mt-32 border-t border-white/5">
        ...
        <div className="space-y-2">
          <FAQItem question="What services do you provide?" answer="I specialize in cinematic media production and brand storytelling, crafting visual experiences that connect and convert." />
          <FAQItem question="How do I start working with you?" answer="You can easily book through my calendar above, and I'll personally reach out to discuss your goals." />
          <FAQItem question="How long does a project take?" answer="Most short-form projects are delivered within 2–3 days. I'll confirm your exact turnaround after reviewing your brief." />
          <FAQItem question="Do you provide revisions?" answer="Absolutely! Each project includes revisions to ensure the final product matches your creative vision." />
        </div>
      </section>
      ...
      <AnimatePresence>
        {isBookingOpen && (
          <motion.div initial={{ y: "100%" }} animate={{ y: 0 }} exit={{ y: "100%" }} transition={{ type: "spring", damping: 25, stiffness: 200 }} className="fixed inset-0 z-[200] bg-[#050505] p-4 md:p-8 flex flex-col">
            <div className="max-w-7xl mx-auto w-full flex-1 flex flex-col text-left">
